...
const RecipeEegSection = ({ recipe, updateRecipe }: RecipeSectionProps) => {
...
const RecipeEmgSection = ({ recipe, updateRecipe, isLab }: RecipeSectionProps) => {
...
const RecipeSyncSection = ({ recipe, updateRecipe }: RecipeSectionProps) => (
...
const RecipePriorSection = ({ recipe, updateRecipe }: RecipeSectionProps) => (
...
const RecipeOutputSection = ({ recipe, updateRecipe }: RecipeSectionProps) => (
...
const RecipeActions = ({ recipe, onLoad }: { recipe: Recipe; onLoad: (event: ChangeEvent<HTMLInputElement>) => void }) => {
...
const RecipePanel = () => {
  ...
  return (
    <section className="space-y-4 rounded-2xl border border-slate-800 bg-slate-900/40 p-4">
      ...
      <MacroDock />
      <RecipeEegSection recipe={recipe} updateRecipe={updateRecipe} isLab={isLab} />
      <RecipeEmgSection recipe={recipe} updateRecipe={updateRecipe} isLab={isLab} />
      <RecipeSyncSection recipe={recipe} updateRecipe={updateRecipe} isLab={isLab} />
      <RecipePriorSection recipe={recipe} updateRecipe={updateRecipe} isLab={isLab} />
      <RecipeOutputSection recipe={recipe} updateRecipe={updateRecipe} isLab={isLab} />
